...
# no button
if st.button("Try again", key="no_maroon_btn"):
    st.switch_page("valentine.py")
...
st.video("videos/cry.mp4", autoplay=True, muted=True, loop=True)
